...
use App\TaskMangement\Paginate\Paginate;
use Exception;
...
class ApiController extends Controller
{
    ...
    {
        // var_dump( get_parent_class($this->transformer) );
        // error_log(print_r($this->transformer, 1));

        if ($this->transformer === null || ! $this->transformer instanceof Transformer) {
            // || ! $this->transformer instanceof Transformer
            // error_log(print_r($this->transformer instanceof Transformer, 1));
